...
func (e *LinkElement) renderTextPart(w io.Writer, ctx RenderContext) error {
	...
	if _, err := io.WriteString(w, linkStartMarker); err != nil {
		return err
	}
	...
	if _, err := io.WriteString(w, linkEndMarker); err != nil {
		return err
	}
	return nil
}
